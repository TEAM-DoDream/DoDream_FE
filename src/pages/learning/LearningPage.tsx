...
import Filter from '@pages/learning/components/Filter';
import { useAcademyInfoQuery } from '@hook/useAcademyInfoQuery';
import { AcademyItem } from '@validation/academy/academySchema';
import Img from '@assets/images/illustration_2.webp';
import Footer from '@common/Footer';
import LearningCard from '@pages/learning/components/LearningCard';
import CardDetail from '@pages/learning/components/CardDetail';
